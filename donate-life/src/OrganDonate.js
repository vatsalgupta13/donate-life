...
const OrganDonate = () => {
	...
	const submitForm = async e => {
		...
		const gas = await organchain.methods.adddonor(donorAddress, age, organ, group, rhFactor).estimateGas();
		const result = organchain.methods.adddonor(donorAddress, age, organ, group, rhFactor).send({ from: account, gas});
		console.log(result);
		console.log(donorAddress, age, group, organ, rhFactor);
	};
	return (
